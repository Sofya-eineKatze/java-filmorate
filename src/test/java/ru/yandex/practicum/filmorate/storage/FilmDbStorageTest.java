...
@Import({FilmRowMapper.class, UserRowMapper.class})
...
class FilmDbStorageTest {
    ...
    void shouldGetPopularFilms() {
        User user = userStorage.create(new User(null, "user@mail.ru", "userLogin", "User Name", LocalDate.of(2000, 1, 1)));
        MpaRating mpa = new MpaRating(1, "G");
        Film film1 = filmStorage.create(new Film(null, "Popular Film", "Desc1", LocalDate.of(2020, 1, 1), 120, new HashSet<>(), new HashSet<>(), mpa));
